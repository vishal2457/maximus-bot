...
const mockIntegrations: Integration[] = [
  { id: "1", name: "Slack", status: "connected", icon: "slack" },
  { id: "2", name: "Discord", status: "disconnected", icon: "discord" },
  { id: "3", name: "WhatsApp", status: "disconnected", icon: "whatsapp" },
  { id: "4", name: "Telegram", status: "connected", icon: "telegram" },
];
...
export const IntegrationsPage = () => {
  const getIcon = (iconName: string) => {
    switch (iconName) {
      case "slack":
        return <Hash size={24} className="text-white" />;
      case "discord":
      ...
      default:
        return <Plug size={24} className="text-[#555]" />;
    }
  };
